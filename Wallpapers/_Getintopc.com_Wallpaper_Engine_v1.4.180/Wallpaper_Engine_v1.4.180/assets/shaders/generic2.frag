...
uniform sampler2D g_Texture1; // {"material":"Normal map","format":"normalmap","combo":"NORMALMAP"}
uniform sampler2D g_Texture2; // {"material":"Reflection","default":"_rt_Reflection","hidden":true}
